...
#cp traefik.ext2.bak traefik.ext2
bash ./scripts/image2rootfs.sh traefik latest ext2

kernel=no-dev-multi
kernel=lupine-djw-nokml
kernel=microvm
kernel=lupine-djw-kml++traefik
...
#--kernel-opts="console=ttyS0 panic=1 init=/usr/local/bin/traefik"
